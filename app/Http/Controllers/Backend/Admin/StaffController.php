...
use App\Http\Requests\Admin\StaffEditRequest;
...
class StaffController extends Controller
{
    ...
    protected $route = "backend.admin.staff.";
    ...
    public function store(StaffCreateRequest $request)
    {
        ...
        return redirect()->route('staff.index')->with('success', '* Successfully Added.');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AdminStaff $staff)
    {
        return view("{$this->route}edit", compact('staff'));
    }
    ...
    public function update(StaffEditRequest $request, $id)
    {
        ...
        return redirect()->route('staff.index')->with('success', '* Successfully Edited.');
    }
