    ...
    removeBtns.forEach(function (e) {
        e.addEventListener("click", function (e) {
            e.target.closest("tr").children[1].innerText,
                ...
                companyList.get({ id: itemId }).forEach(function (e) {
...
addBtn.addEventListener("click", function (e) {
    "" !== customerNameField.value &&
        ...
        (companyList.add({
            ...
            image_src:
                "https://managely.themesbrand.com/backend/images/logo-sm.png",
        }),
        companyList.sort("id", { order: "desc" }),
    ...
    editBtn.addEventListener("click", function (e) {
        (document.getElementById("exampleModalLabel").innerHTML =
            "Edit Company"),
            companyList.get({ id: idField.value }).forEach(function (e) {
                (isid = new DOMParser().parseFromString(
                    e._values.id,
                    "text/html"
                )),
