        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('main.accountant') }} {{ __('main.edit') }}  </h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0 flex-grow-1"> {{ __('main.accountant') }} {{ __('main.edit') }} </h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('accountant.update', $accountant->id ) }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control @error('username')is-invalid @enderror" id="username" name="username" value="{{ $accountant->username }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input type="email" class="form-control @error('email')is-invalid @enderror" id="email" name="email" value="{{ $accountant->email }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input type="tel" class="form-control @error('phone')is-invalid @enderror" id="phone" name="phone" value="{{ $accountant->phone }}">
                                </div>
                            </div>
