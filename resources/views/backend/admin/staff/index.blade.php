        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('account-setting.staff_lists') }}</h4>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0 flex-grow-1"> {{ __('account-setting.staff_lists') }} </h4>
                    </div><!-- end card header -->
...
<script src="{{ asset('backend/js/datatable/staff.js') }}"></script>
