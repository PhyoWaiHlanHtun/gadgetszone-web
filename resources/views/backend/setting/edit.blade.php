        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('main.profile')}} {{__('main.edit') }}</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0 flex-grow-1"> {{ __('main.user')}} {{__('main.edit')}} </h4>
                    </div>
                    <div class="card-body">
                        @if( Auth::guard('agent')->check())
                        <form action="{{ route('backend.agent.update') }}" method="post">
                        @else
