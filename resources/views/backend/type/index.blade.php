         ...
         <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('product.sub_cat_list') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('main.home') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('product.sub_cat') }}</li>
                        </ol>
                    </div>
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($types as $key => $cate)
                                            <tr>
                                                <td class="photo">
                                                    <div class="flex-shrink-0">
                                                        <div>
                                                            @if( $cate->photo )
                                                            <img class="image avatar-xl img-thumbnail" alt="" src="{{ asset('storage/images/type/'.$cate->photo) }}">
                                                            @endif
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <a class="btn btn-sm btn-success edit-item-btn" href="{{ route('types.edit',$cate->id) }}">
                                                            {{ __('main.edit') }}
                                                            </a>
                                                        </div>
                                                        {{-- <div class="remove">
                                                            <a href='#' class='btn btn-danger btn-sm ml-3' id='delete-btn' data-id="{{ $cate->id }}" data-type="types" data-bs-toggle="modal" data-bs-target="#deleteModal">
                                                                {{ __('main.delete') }}
                                                            </a>
                                                        </div> --}}
                                                    </div>
                    ...
                    <form action="{{ route('types.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                {{-- <input type="text" id="categoryname-field" class="form-control" name="name" placeholder="Enter Sub Category name" required /> --}}
                            </div>
                            <div class="mb-3">
    ...
    document.getElementById("showCreateModal") && (
        document.getElementById("showCreateModal").addEventListener("show.bs.modal", (e) => {
            e.relatedTarget.classList.contains("add-btn") ? (
                (document.getElementById("exampleModalCreate").innerHTML = "Add Sub Category"),
