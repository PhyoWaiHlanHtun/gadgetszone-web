                    ...
                    <div class="slide-home3">
                        <div class="e-slide v2 js-slider-3items">
                            ...
                            <div class="e-slide-img">
                                ...
                                <div class="slide-content v2">
                                    <p class="cate v2 white">Welcome to E-Come Zone</p>
                                    <h3 class="v2 white">Your Home <br>
                                        Smart Devices & <br>
                                         Best Solution </h3>
                                    <a href="#" class="slide-btn e-yl-gradient white">Shop now<i
                                            class="ion-ios-arrow-forward"></i></a>
        ...
        <div class="container container-240">
            ...
            {{-- <div class="row">
                <div class="product-item">
                    <div class="pd-bd product-inner">
                        <div class="product-img">
                            <a href="#"><img src="{{ asset('frontend/img/product/pd2.jpg') }}" alt=""
                                    class="img-reponsive"></a>
                        </div>
                        <div class="product-info">
            ...
            {{-- <div class="tab-content">
                <div id="tv2" class="tab-pane active">
                    <div class="js-multiple-row2">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/pd3.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/pd4.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/logitech.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/tv2.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/headphone3.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/samsungbox.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/smartwatch.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/macbook2.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                        ...
                        <div class="product-item">
                            <div class="pd-bd product-inner">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/sound2.jpg') }}" alt=""
                                            class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
