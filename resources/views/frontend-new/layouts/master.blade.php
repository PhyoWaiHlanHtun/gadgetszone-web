    ...
    <div class="wrappage">
        <header id="header" class="header-v1">
            <div class="header-top-banner">
                <a href="#"><img src="{{ asset('frontend/img/banner-top.jpg') }}" alt="" class="img-reponsive"></a>
            </div>
            <div class="topbar">
                    ...
                    <div class="row flex">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-8 flex-right">
                            <div class="topbar-right">
                                ...
                                <div class="element hidden-xs hidden-sm">
                                    <a href="#"><img src="{{ asset('frontend/img/icon-phone.png') }}" alt=""><span>Save big on our app!</span></a>
                                </div>
                                <div class="element element-leaguage">
                                    <a id="label2" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <img src="{{ asset('frontend/img/icon-l.png') }}" alt="">
                                      <span>English</span>
                ...
                <div class="container container-240">
                    <div class="row flex">
                        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 v-center header-logo">
                            <a href="#"><img src="{{ asset('frontend/img/logo.png') }}" alt="" class="img-reponsive"></a>
                        </div>
                                ...
                                <nav class="main-menu">
                                    <div class="collapse navbar-collapse" id="myNavbar">
                                        <ul class="nav navbar-nav">
                                            <li class="level1"><a href="#"><img src="{{ asset('frontend/img/icon-diamond.png') }}" alt="">Flash Deals</a></li>
                                ...
                                <div class="slide">
                                    <div class="e-slide v2 js-slider-3items">
                                        <div class="e-slide-img v2">
                                            <a href="#"><img src="{{ asset('frontend/img/slider/h1_s1.jpg') }}" alt=""></a>
                                        ...
                                        <div class="e-slide-img v2">
                                            <a href="#"><img src="{{ asset('frontend/img/slider/h1_s2.jpg') }}" alt=""></a>
                                            <div class="box-center slide-content v3">
                                                <p class="cate v2 white text-center">Power to the pro</p>
                                                <h3 class="white v3 text-center">The vision is brighter than ever.</h3>
                                                <a href="#" class="slide-btn e-red-gradient">Shop now<i class="ion-ios-arrow-forward"></i></a>
                                        ...
                                        <div class="e-slide-img v2">
                                            <a href="#"><img src="{{ asset('frontend/img/slider/h1_s3.jpg') }}" alt=""></a>
                                            <div class="box-center slide-content v3">
                                                <p class="cate v2 white text-center">Power to the pro</p>
                                                <h3 class="white v3 text-center">The vision is brighter than ever.</h3>
                                                <a href="#" class="slide-btn e-red-gradient">Shop now<i class="ion-ios-arrow-forward"></i></a>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="ads">
                                    <div class="banner-img banner-img2">
                                        <a href="#"><img src="{{ asset('frontend/img/banner/h1_b1.jpg') }}" alt="" class="img-responsive"></a>
            ...
            <div class="container container-240">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="banner-img banner-img2">
                            <a href="#"><img src="{{ asset('frontend/img/banner/h1_b2.jpg') }}" alt="" class="img-responsive"></a>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="banner-img banner-img2">
                            <a href="#"><img src="{{ asset('frontend/img/banner/h1_b3.jpg') }}" alt="" class="img-responsive"></a>
                            <div class="h-banner-content">
        ...
        <div class="flash-deals">
            <div class="container container-240">
                <div class="title-icon t-column">
                    <div class="t-inside">
                        <img src="{{ asset('frontend/img/flash-deals.png') }}" alt="">
                    </div>
                    <h1>Flash Deals</h1>
                </div>
                <div class="owl-carousel owl-theme owl-cate js-owl-cate2">
                    <div class="product-countd pd-bd product-inner">
                        <div class="product-item-countd">
                            <div class="product-head product-img">
                                <a href="#"><img src="{{ asset('frontend/img/product/headphone5.jpg') }}" alt=""></a>
                    ...
                    <div class="product-countd pd-bd product-inner">
                        <div class="product-item-countd">
                            <div class="product-head">
                                <a href="#"><img src="{{ asset('frontend/img/product/security.jpg') }}" alt=""></a>
                                <div class="ribbon-price v3 red"><span>- 30% </span></div>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="product-countd pd-bd product-inner">
                        <div class="product-item-countd">
                            <div class="product-head">
                                <a href="#"><img src="{{ asset('frontend/img/product/iphonex.jpg') }}" alt=""></a>
                                <div class="ribbon-price v3 red"><span>- 30% </span></div>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="product-countd pd-bd product-inner">
                        <div class="product-item-countd">
                            <div class="product-head">
                                <a href="#"><img src="{{ asset('frontend/img/product/headphone2.jpg') }}" alt=""></a>
                            </div>
                            <div class="product-info">
                                <p class="product-cate text-center">Head phones</p>
                                <div class="product-price thin-price v3">
                    ...
                    <div class="product-countd pd-bd product-inner">
                        <div class="product-item-countd">
                            <div class="product-head">
                                <a href="#"><img src="{{ asset('frontend/img/product/sonos.jpg') }}" alt=""></a>
                            </div>
                            <div class="product-info">
                                <p class="product-cate text-center">Head phones</p>
                                <div class="product-price thin-price v3">
                    ...
                    <div class="product-countd pd-bd product-inner">
                        <div class="product-item-countd">
                            <div class="product-head">
                                <a href="#"><img src="{{ asset('frontend/img/product/headphone4.jpg') }}" alt=""></a>
                            </div>
                            <div class="product-info">
                                <p class="product-cate text-center">Head phones</p>
                                <div class="product-price thin-price v3">
                    ...
                    <div class="product-countd pd-bd product-inner">
                        <div class="product-item-countd">
                            <div class="product-head">
                                <a href="#"><img src="{{ asset('frontend/img/product/fujifilm.jpg') }}" alt=""></a>
                            </div>
                            <div class="product-info">
                                <p class="product-cate text-center">Head phones</p>
                                <div class="product-price thin-price v3">
                        ...
                        <div class="product-tab-pd js-multiple-row2">
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/sound3.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/pd2.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/pd3.jpg') }}" alt="" class="img-reponsive"></a>
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/pd4.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/sound.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                            <a href="#" class="circle black"></a>
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/sound2.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                        </div>
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/samsung3.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                        </div>
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/macbook2.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                        </div>
            ...
            <div class="container container-240">
                <div class="h-heading">
                    <div class="title-icon t-inline">
                        <img src="{{ asset('frontend/img/iconbs.png') }}" alt="">
                        <h1>Best Sellers</h1>
                    </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 product-item">
                                <div class="pd-bd product-inner v3">
                                    <div class="product-img v2">
                                        <a href="#"><img src="{{ asset('frontend/img/b-product1.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                            <a href="#" class="circle black"></a>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 product-item">
                                        <div class="pd-bd product-inner">
                                            <div class="product-img">
                                                <a href="#"><img src="{{ asset('frontend/img/product/xbox.jpg') }}" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                <div class="color-group">
                                                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 product-item">
                                        <div class="pd-bd product-inner">
                                            <div class="product-img">
                                                <a href="#"><img src="{{ asset('frontend/img/product/fujifilm.jpg') }}" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                <div class="color-group">
                                                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 product-item">
                                        <div class="pd-bd product-inner">
                                            <div class="product-img">
                                                <a href="#"><img src="{{ asset('frontend/img/product/ring.jpg') }}" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                <div class="color-group">
                                                </div>
                    ...
                    <div id="audito" class="tab-pane fade">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 product-item">
                                <div class="pd-bd product-inner v3">
                                    <div class="product-img v2">
                                        <a href="#"><img src="{{ asset('frontend/img/b-product2.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                            <a href="#" class="circle black"></a>
                    ...
                    <div id="camera" class="tab-pane fade">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 product-item">
                                <div class="pd-bd product-inner v3">
                                    <div class="product-img v2">
                                        <a href="#"><img src="{{ asset('frontend/img/b-product3.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                            <a href="#" class="circle black"></a>
                    ...
                    <div id="phone" class="tab-pane fade">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 product-item">
                                <div class="pd-bd product-inner v3">
                                    <div class="product-img v2">
                                        <a href="#"><img src="{{ asset('frontend/img/b-product4.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                            <a href="#" class="circle black"></a>
        ...
        <div class="homepage-banner">
            <div class="container container-240">
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="banner-img banner-img2">
                            <a href="#"><img src="{{ asset('frontend/img/banner/h1_b4.jpg') }}" alt="" class="img-responsive"></a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="banner-img banner-img2">
                            <a href="#"><img src="{{ asset('frontend/img/banner/h1_b5.jpg') }}" alt="" class="img-responsive"></a>
                            <div class="h-banner-content v2">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="banner-img banner-img2">
                            <a href="#"><img src="{{ asset('frontend/img/banner/h1_b6.jpg') }}" alt="" class="img-responsive"></a>
                            <div class="h-banner-content v2">
                    ...
                    <div id="tv2" class="tab-pane fade in active">
                        <div class="owl-carousel owl-theme owl-cate v3 js-owl-cate">
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/tv2.jpg') }}" alt="" class="img-reponsive"></a>
                                        <div class="ribbon-price red"><span>- 30% </span></div>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/headphone3.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                        </div>
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/samsungbox.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                        </div>
                            ...
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/smartwatch.jpg') }}" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                                        </div>
                    ...
                    <div id="audito2" class="tab-pane fade">
                        <div class="owl-carousel owl-theme owl-cate v3 js-owl-cate">
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/tv.jpg') }}" alt="" class="img-reponsive"></a>
                                        <div class="ribbon-price red"><span>- 30% </span></div>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                    ...
                    <div id="phone2" class="tab-pane fade">
                        <div class="owl-carousel owl-theme owl-cate v3 js-owl-cate">
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/samsung.jpg') }}" alt="" class="img-reponsive"></a>
                                        <div class="ribbon-price red"><span>- 30% </span></div>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
                    ...
                    <div id="headphone2" class="tab-pane fade">
                        <div class="owl-carousel owl-theme owl-cate v3 js-owl-cate">
                            <div class="product-item">
                                <div class="pd-bd product-inner">
                                    <div class="product-img">
                                        <a href="#"><img src="{{ asset('frontend/img/product/headphone.jpg') }}" alt="" class="img-reponsive"></a>
                                        <div class="ribbon-price red"><span>- 30% </span></div>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
            ...
            <div class="brand">
                <div class="ecome-heading style5v3 spc4">
                    <div class="title-icon t-inline t-line">
                        <img src="{{ asset('frontend/img/iconbrand.png') }}" alt="">
                        <h1>Shop by brand</h1>
                    </div>
                ...
                <div class="owl-carousel owl-theme owl-brand js-owl-brand">
                    <div class="brand-item">
                        <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/brand.png') }}" alt=""></a>
                    </div>
                    <div class="brand-item">
                        <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/brand_2.png') }}" alt=""></a>
                    </div>
                    <div class="brand-item">
                        <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/brand_3.png') }}" alt=""></a>
                    </div>
                    <div class="brand-item">
                        <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/brand_4.png') }}" alt=""></a>
                    </div>
                    <div class="brand-item">
                        <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/brand_5.png') }}" alt=""></a>
                    </div>
                    <div class="brand-item">
                        <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/brand_7.png') }}" alt=""></a>
                    </div>
                    <div class="brand-item">
                        <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/brand_8.png') }}" alt=""></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-sm-3 col-md-4">
                            <div class="about-brand-info text-center">
                                <div class="brand-img">
                                    <a href="#" class="hover-images"><img src="{{ asset('frontend/img/brand/sony_info.png') }}" alt=""></a>
                                </div>
                            ...
                            <div class="row engoc-equal-row">
                                <div class="col-xs-6 col-sm-6 col-md-6 product-item">
                                    <div class="pd-bd product-inner v2">
                                        <div class="flex align-center">
                                            <div class="product-img">
                                                <a href="#"><img src="{{ asset('frontend/img/product/tplink.jpg') }}" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                <div class="color-group">
                                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 product-item">
                                    <div class="pd-bd product-inner v2">
                                        <div class="flex align-center">
                                            <div class="product-img">
                                                <a href="#"><img src="{{ asset('frontend/img/product/wifi.jpg') }}" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                <div class="color-group">
                                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 product-item">
                                    <div class="pd-bd product-inner v2">
                                        <div class="flex align-center">
                                            <div class="product-img">
                                                <a href="#"><img src="{{ asset('frontend/img/product/phone5.jpg') }}" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                <div class="color-group">
                                                </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 product-item">
                                    <div class="pd-bd product-inner v2">
                                        <div class="flex align-center">
                                            <div class="product-img">
                                                <a href="#"><img src="{{ asset('frontend/img/product/logitech.jpg') }}" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                <div class="color-group">
                                                </div>
            ...
            <div class="container container-240">
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        ...
                        <div class="cate-item">
                            <div class="product-img">
                                <a href="#"><img src="{{ asset('frontend/img/product/usb.jpg') }}" alt="" class="img-reponsive"></a>
                            </div>
                            <div class="product-info">
                        ...
                        <div class="cate-item">
                            <div class="product-img">
                                <a href="#"><img src="{{ asset('frontend/img/product/macbook.jpg') }}" alt="" class="img-reponsive"></a>
                            </div>
                            <div class="product-info">
                                <h3 class="product-title"><a href="#">Epson Home Cinema 5040UB </a></h3>
                                <div class="product-price v2"><span>$780.00</span></div>
                        ...
                        <div class="cate-item">
                            <div class="product-img">
                                <a href="#"><img src="{{ asset('frontend/img/product/flycam.jpg') }}" alt="" class="img-reponsive"></a>
                            </div>
                            <div class="product-info">
                                <h3 class="product-title"><a href="#">Epson Home Cinema 5040UB </a></h3>
                                <div class="product-price v2"><span>$780.00</span></div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        ...
                        <div class="cate-item">
                            <div class="product-img">
                                <a href="#"><img src="{{ asset('frontend/img/product/headphone2.jpg') }}" alt="" class="img-reponsive"></a>
                            </div>
                            <div class="product-info">
                                <h3 class="product-title"><a href="#">Epson Home Cinema 5040UB </a></h3>
                                <div class="product-price v2"><span>$780.00</span></div>
                        ...
                        <div class="cate-item">
                            <div class="product-img">
                                <a href="#"><img src="{{ asset('frontend/img/product/anker.jpg') }}" alt="" class="img-reponsive"></a>
                            </div>
                            <div class="product-info">
                                <h3 class="product-title"><a href="#">Epson Home Cinema 5040UB </a></h3>
                                <div class="product-price v2"><span>$780.00</span></div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        ...
                        <div class="cate-item">
                            <div class="product-img">
                                <a href="#"><img src="{{ asset('frontend/img/product/samsung2.jpg') }}" alt="" class="img-reponsive"></a>
                            </div>
                            <div class="product-info">
                                <h3 class="product-title"><a href="#">Epson Home Cinema 5040UB </a></h3>
                                <div class="product-price v2"><span>$780.00</span></div>
        ...
        <div class="container container-240">
            <div class="banner-callus spc1 image-bd effect_img2">
                <a href="#"><img src="{{ asset('frontend/img/banner/h1_b7.jpg') }}" alt="" class="img-responsive"></a>
                ...
                <div class="multiple-row js-multiple-row">
                    <div class="product-item">
                        <div class="pd-bd product-inner v2">
                            <div class="flex align-center">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/ipad.jpg') }}" alt="" class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                                    </div>
                    ...
                    <div class="product-item">
                        <div class="pd-bd product-inner v2">
                            <div class="flex align-center">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/sonos.jpg') }}" alt="" class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                                    </div>
                    ...
                    <div class="product-item">
                        <div class="pd-bd product-inner v2">
                            <div class="flex align-center">
                                <div class="product-img">
                                    <a href="#"><img src="{{ asset('frontend/img/product/phone2.jpg') }}" alt="" class="img-reponsive"></a>
                                </div>
                                <div class="product-info">
                                    <div class="color-group">
                                    </div>
            ...
            <div class="container container-240">
                <div class="feature-inside">
                    <div class="feature-block text-center">
                        <div class="feature-block-img"><img src="{{ asset('frontend/img/feature/truck.png') }}" alt="" class="img-reponsive"></div>
                    ...
                    <div class="feature-block text-center">
                        <div class="feature-block-img"><img src="{{ asset('frontend/img/feature/credit-card.png') }}" alt="" class="img-reponsive"></div>
                        <div class="feature-info">
                            <h3>Safe Payment</h3>
                    ...
                    <div class="feature-block text-center">
                        <div class="feature-block-img"><img src="{{ asset('frontend/img/feature/safety.png') }}" alt="" class="img-reponsive"></div>
                        <div class="feature-info">
                    ...
                    <div class="feature-block text-center">
                        <div class="feature-block-img"><img src="{{ asset('frontend/img/feature/telephone.png') }}" alt="" class="img-reponsive"></div>
                        <div class="feature-info">
