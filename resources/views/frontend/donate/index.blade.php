...
<div class="pt-100px pb-100px">
    <div class="container">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row d-flex justify-content-center my-3" id="pay-money">
                            ...
                            <a href="javascript:void(0)" class="col-md-6 text-center" id="pay-amount-box" data-amount="50">
                                $50.00
                            </a>
                            ...
                            <a href="javascript:void(0)" class="col-md-6 text-center" id="pay-amount-box" data-amount="2000">
                                $2,000.00
                            </a>
            ...
            <form action="/donate/payment" method="get" id="payform">
