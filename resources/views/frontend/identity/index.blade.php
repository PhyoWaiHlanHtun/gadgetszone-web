...
<div class="pt-100px pb-100px">
    <div class="container">
        <div class="row">
            ...
            <h4 class="my-4 text-center"> {{ __('frontend.upload_id')}} </h4>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/user-identity/upload" method="post" id="idcard-form" enctype="multipart/form-data">
                                ...
                                <div class="my-3">
                                    ...
                                    <input type="text" class="form-control @error('number') is-invalid @enderror" name="number" id="number" value="{{ old('number') }}" placeholder="">
                                </div>
